module github.com/LerianStudio/lib-commons

go 1.23.2

require (
	github.com/LerianStudio/lib-license-go v1.0.9
...
require (
	...
	go.opentelemetry.io/otel/log/logtest v0.0.0-20250602124505-69613e481028 // indirect
