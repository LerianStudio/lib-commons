...
const (
	...
	HeaderTraceparent = obsconstants.HeaderTraceparentPascal
	...
	HeaderTraceparentPascal = obsconstants.HeaderTraceparentPascal
	// HeaderTracestatePascal is the PascalCase variant of the Tracestate header for gRPC metadata.
	HeaderTracestatePascal = obsconstants.HeaderTracestatePascal
