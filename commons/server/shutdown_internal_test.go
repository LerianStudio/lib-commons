...
func TestSameListenAddress(t *testing.T) {
	...
	cases := []struct {
		...
		{"two spellings of one scoped IPv6 address", "[fe80::1%eth0]:8080", "[fe80:0:0:0:0:0:0:1%eth0]:8080", true},
		{"one IPv6 address on two zones", "[fe80::1%eth0]:8080", "[fe80::1%eth1]:8080", false},
		{"IPv4-mapped IPv6 equals its IPv4 form", "[::ffff:127.0.0.1]:8080", "127.0.0.1:8080", true},
