...
func TestValidateCode(t *testing.T) {
	tests := []struct {
		...
		{name: "Lowercase Letters", input: "usd", expected: errors.New("0004")},
		{name: "Contains Number", input: "US1", expected: errors.New("0033")},
		{name: "Contains Symbol", input: "US$", expected: errors.New("0033")},
...
func TestValidateCurrency(t *testing.T) {
	tests := []struct {
		...
		{name: "Invalid Currency Code", input: "ABC", expected: errors.New("0005")},
		{name: "Empty Currency Code", input: "", expected: errors.New("0005")},
		{name: "Lowercase Currency Code", input: "usd", expected: errors.New("0005")},
	}
