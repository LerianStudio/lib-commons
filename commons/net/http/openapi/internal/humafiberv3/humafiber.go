// Package humafiberv3 is a vendored copy of the Fiber v3 adapter from
// github.com/danielgtaylor/huma/v2/adapters/humafiber (huma v2.38.0).
//
// It is vendored so lib-commons can use huma's Fiber v3 binding WITHOUT
// importing the upstream humafiber package, whose single package also ships a
// Fiber v2 adapter file and therefore drags github.com/gofiber/fiber/v2 into
// the module graph (flagged, with no fixed version, by CVE-2026-45045). Only
// the self-contained v3 file is copied here (imports: huma/v2 + fiber/v3 +
// stdlib). No functional changes; the package name is the only edit.
//
// Upstream is MIT-licensed — see the LICENSE file in this directory.
// Remove this vendored copy once humafiber splits its adapters into
// version-specific subpackages (upstream tracking issue filed separately).
//
// Source: github.com/danielgtaylor/huma/v2@v2.38.0/adapters/humafiber/humafiber.go
package humafiberv3
