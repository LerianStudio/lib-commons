...
// explicitly set RATE_LIMIT_ENABLED=true, or pass WithEnabled(true) to decide
// in code, to enable enforcement) or when the Redis connection is nil. A nil *RateLimiter is always safe to use:
