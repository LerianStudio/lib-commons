// Package poolmanager provides multi-tenant database connection management.
// It fetches tenant-specific database credentials from Pool Manager service
...
// TenantConfig represents the tenant configuration from Pool Manager.
