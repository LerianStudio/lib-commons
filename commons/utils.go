...
// For backward compatibility - delegates to validators package
func ValidateCountryAddress(country string) error {
	// Import from validators package
	validator := validators.NewBasic()
	return validator.ValidateCountryAddress(country)
}
...
func ValidateAccountType(t string) error {
	// Import from validators package
	validator := validators.NewBasic()
	return validator.ValidateAccountType(t)
}
...
func ValidateType(t string) error {
	// Import from validators package
	validator := validators.NewBasic()
	return validator.ValidateType(t)
}

// ValidateCode checks if a code consists of uppercase letters only
...
func ValidateCurrency(code string) error {
	// Import from validators package
	validator := validators.NewBasic()
	return validator.ValidateCurrency(code)
}
